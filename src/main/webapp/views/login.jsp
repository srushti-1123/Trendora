...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth-card { background-color: #fff; border-radius: 16px; padding: 40px; width: 100%; max-width: 480px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); }
        ...
        .input-group input { border: none; outline: none; padding: 12px 15px; width: 100%; font-size: 14px; background-color: #fff; }
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                <h2>Welcome Back!</h2>
                <p>Login to your Trendora account</p>
            </div>
